...
Expect it to cost more tokens than an unstructured investigation, not fewer — measured between 11% and 121.2% more on small local datasets so far, a premium that rises with analysis complexity and has no measured ceiling (`tests/scenarios.md`).
