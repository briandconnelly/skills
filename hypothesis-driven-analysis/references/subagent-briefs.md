...
- The disposition of a faulted return belongs to SKILL.md's Analysis section, which is the single authority — read the rule there and apply it from there.
  No summary of it belongs here: this rule drifted into a contradiction once precisely because it lived in two places, and a paraphrase is how that starts again.
