...
| T2 | H2 | material db p95 / index-usage shift if true; flat refutes | worker W2: query `db_slowlog` both days, compare field by field | NOT_TESTED | no W2 return — harness notice preserved (worker-returns.md) |
