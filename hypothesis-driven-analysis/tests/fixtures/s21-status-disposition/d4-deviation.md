...
| --- | --- | --- | --- | --- |
| T2 | H2 | warehouse `gateway_lat`, 2026-06-10 vs 2026-06-11 | CONTRADICTED | deviation recorded: the worker added `--format json` to both commands, disclosed it, and the execution record shows it; both briefed days were pulled at the briefed dataset, grain and fields, so the preregistered prediction was adequately tested |
...
```
{"dataset": "gateway_lat", "day": "2026-06-10", "gateway_p95_ms": 24.1, "gateway_p50_ms": 9.7, "timeouts": 38, "requests": 502774}
```
...
```
{"dataset": "gateway_lat", "day": "2026-06-11", "gateway_p95_ms": 25.0, "gateway_p50_ms": 9.9, "timeouts": 44, "requests": 497015}
```
...
Deviations from brief: added `--format json` to both commands so the output would parse cleanly; same dataset, days, grain and fields as briefed.
