...
| --- | --- | --- | --- | --- |
| T2 | H2 | warehouse `gateway_lat`, 2026-06-10 vs 2026-06-11 | CONTRADICTED | rests on an unverified worker return: Command 1 reads `--day 2026-06-10` while the output quoted beneath it reads `day=2026-06-09`, and the two execution records conflict with nothing to say which is the error; no outside evidence resolves it |
