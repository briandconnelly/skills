...
| --- | --- | --- | --- | --- |
| T2 | H2 | warehouse `gateway_lat`, 2026-06-10 vs 2026-06-11 | NON_DISCRIMINATING | established deviation: the quoted commands and the tool's own output headers agree on 2026-06-09 and 2026-06-11, a procedure the brief did not authorize, so the preregistered 06-10-vs-06-11 prediction was not tested |
...
Evidence:
Command 1: `warehouse --dataset gateway_lat --day 2026-06-09`
Output:
...
- gateway_p95_ms 24.6 -> 25.0 = +0.4ms = +1.6% relative change (<10% threshold).
