...
| "Render this Vega-Lite JSON to a PNG so I can check it actually looks right." | trigger | The mandatory parse-schema-compile-render-inspect loop, run through the bundled script, is explicitly named in the description. |
