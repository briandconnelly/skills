...
Collect reports with `bash review-pr/tests/lens-fixture-test.sh --runner codex --arm lens --runs 3 --collect-only`, then complete the [independent semantic assessment](../../tests/lens-rubric.md) and run `python3 review-pr/tests/score-lens.py review-pr/tests/evidence/lens/codex/semantic-v1` for the review-quality gate.
