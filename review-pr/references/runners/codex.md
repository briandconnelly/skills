...
Collect reports and apply the [review-quality gate](../../tests/lens-rubric.md) with `bash review-pr/tests/lens-fixture-test.sh --runner codex --case legacy --snapshot baseline --runs 3`; replay it with `python3 review-pr/tests/score-lens.py review-pr/tests/evidence/lens/cases/legacy/codex/baseline --gate`.
