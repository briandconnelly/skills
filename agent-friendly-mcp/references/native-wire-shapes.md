...
**Not exhaustive.**
This covers the high-risk native shapes — list pagination, completion, the `tools/call` result envelope, and the experimental task lifecycle — not the full protocol surface.
