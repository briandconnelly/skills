...
Checkpoint: §3, §4.
See `examples.md` §1 for a worked tool schema and §5 for a prompt scaffold.
...
Checkpoint: §1, §2, §4.
See `examples.md` §7 for a server capability summary and §8 for a `search_tools` response.
...
Checkpoint: §6.
See `examples.md` §6 for an actionable error payload.
